...
// Ensure rotator implements the Rotator interface
...
func (cr *rotator) Rotate(c *Credential, newMaterial []byte, newAlgo *string) {
	if c == nil {
...
func (cr *rotator) ValidateRotation(c *Credential, newMaterial []byte, newAlgo *string) error {
	if c == nil {

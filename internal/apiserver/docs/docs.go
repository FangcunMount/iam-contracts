    ...
    "paths": {
        ...
        "/v4/authz/role-inheritances": {
            "get": {
                ...
                "summary": "角色继承已退役",
                "operationId": "retiredRoleInheritanceList",
                "responses": {
                    "410": {
            ...
            "post": {
                ...
                "summary": "角色继承已退役",
                "operationId": "retiredRoleInheritanceCreate",
                "responses": {
                    "410": {
                        "description": "角色继承已退役，请直接分配多个角色",
                        "schema": {
        ...
        "/v4/authz/role-inheritances/{id}": {
            "delete": {
                ...
                "summary": "角色继承已退役",
                "operationId": "retiredRoleInheritanceDelete",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Historical inheritance ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "github_com_FangcunMount_iam_v2_internal_apiserver_transport_rest_authz_dto.CreatePermissionGrantRequest": {
            ...
            "properties": {
                ...
                "constraint_set": {
                    "$ref": "#/definitions/github_com_FangcunMount_iam_v2_internal_pkg_authzcompat.Constraints"
                },
                "resource_id": {
                    "type": "string"
                },
        ...
        "github_com_FangcunMount_iam_v2_internal_apiserver_transport_rest_authz_dto.CreateResourceRequest": {
            ...
            "properties": {
                ...
                "attribute_schema": {
                    "$ref": "#/definitions/github_com_FangcunMount_iam_v2_internal_pkg_authzcompat.Schema"
                },
                "description": {
                    "type": "string"
                },
        ...
        "github_com_FangcunMount_iam_v2_internal_apiserver_transport_rest_identity_response.PermissionResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string"
        ...
        "github_com_FangcunMount_iam_v2_internal_apiserver_transport_rest_identity_response.UserResponse": {
            ...
            "properties": {
                ...
                "permissions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_FangcunMount_iam_v2_internal_apiserver_transport_rest_identity_response.PermissionResponse"
                    }
                },
                "roles": {
                    "type": "array",
        ...
        "github_com_FangcunMount_iam_v2_internal_pkg_authzcompat.Constraints": {
            "type": "object",
            "properties": {
                "all_of": {
                    "type": "array",
        ...
        "github_com_FangcunMount_iam_v2_internal_pkg_authzcompat.Schema": {
            "type": "object",
            "properties": {
                "attributes": {
                    "type": "array",

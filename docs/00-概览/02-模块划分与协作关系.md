...
| 能访问什么 | AuthZ | Subject、Resource、Action、Role、Assignment、DirectRoles、PermissionGrant |
...
```text
维护 Resource、Action、Role、Assignment、PermissionGrant 和 直接角色与资源动作匹配；运行时仅解析直接 Assignment，多角色权限取并集；
执行权限检查；
管理授权写入；
...
| AuthZ | Subject、Resource、Action、Role、Assignment、DirectRoles、PermissionGrant、AuthorizationDecision、PolicyVersion | Identity.User/Profile 引用；AuthN 认证结果 | 登录认证、Token 签发、User/Profile 写模型和业务关系事实 |

...
| authorization | Subject、Resource、Action、受信 ObjectAttributes、当前 snapshot | allow/deny + reason/version | PermissionDenied |
...
flowchart LR
    ...
    SUB --> REQ["Resource + Action + ObjectAttributes"]

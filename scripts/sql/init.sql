...
CREATE TABLE IF NOT EXISTS `guardianships` (
    ...
    KEY `idx_deleted_at` (`deleted_at`)
    -- 注意：使用软删除时，不建议使用外键约束，在应用层保证一致性
    -- CONSTRAINT `fk_guardianships_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
    -- CONSTRAINT `fk_guardianships_child` FOREIGN KEY (`child_id`) REFERENCES `children` (`id`)
